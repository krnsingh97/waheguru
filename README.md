...
<p>Created a toy shop website</p>
<p></p>
<p>addes two databese table with unique primery key</p>
<p>3.	Created a new ASP.NET MVC web application including BOTH authentication (Individual User Accounts) or unit testing</p>
<p>4.	Used Entity Framework to generate Model classes based on the two tables in your database</p>
<p>add links to your Index views for both of the new Controllers you have created.</p>
